...
import styles from "./AdminFoundingsItem.module.scss";
...
interface AdminCompetitorsItemProps {
    foundingType: IFoundingType,
    setFoundingTypeId: (foundingTypeId: number) => void,
    setActiveModal: (activeModal: boolean) => void
}

const AdminFoundingsItem: FC<AdminCompetitorsItemProps> = ({foundingType, setActiveModal, setFoundingTypeId}) => {

    const deleteHandler = () => {
        setFoundingTypeId(foundingType.id);
        setActiveModal(true);
    }
    ...
    return (
        <div className={styles.item}>
            <div className={styles.left}>
                <div className={styles.title}>{foundingType.name}</div>
            </div>

            <div className={styles.right}>
                <Link href={`/admin/founding/${foundingType.id}`}>
                    <button
...
export default AdminFoundingsItem;
