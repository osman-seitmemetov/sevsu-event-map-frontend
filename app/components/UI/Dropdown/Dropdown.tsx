...
const Dropdown: FC<DropdownProps> = ({title, children, isBig}) => {
    ...
    return (
        <div className={`${styles.dropdown} ${isOpen && styles.dropdown_active} ${isBig && styles.dropdown_big}`}>
            <div onClick={() => openHandler()} className={styles.head}>
